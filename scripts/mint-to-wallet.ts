...
async function main() {
    ...
    console.log('========================================')
    console.log('RNSID Token-2022 Mint Script')
    console.log('========================================')
    ...
    console.log('Project Mint PDA:', nonTransferableProjectMint.toBase58())
    console.log('')
    ...
    try {
        ...
        console.log('⚠️  Project not initialized, initializing...')
    }
    ...
    if (!projectExists) {
        ...
        console.log('✅ Fee recipient set, tx:', tx2)
    }

    // 2. 先授权
    console.log('\n--- Step 2: Authorize Mint ---')

    const rnsId = 'devnet-test-' + Date.now()
    ...
    try {
        ...
        console.log('NFT Mint:', nonTransferableNftMint.toBase58())
        console.log('')
        console.log('Metadata URI:', `https://api.rns.id/api/v2/portal/identity/nft/${rnsId}.json`)
        console.log('')
