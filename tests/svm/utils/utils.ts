...
// ============================================
// V3 Version - Token-2022 + Optimized Account Structure
// ============================================

// Project account PDA (v3)
...
// DID status account PDA (v3) - merged the original 3 accounts
...
// ============================================
// Legacy Compatibility (v2) - Kept but marked as deprecated
// ============================================

/** @deprecated Use findDIDStatus instead */
